...
int main()
{
	RenderWindow window(VideoMode(640, 480), "TestGame");
	view.reset(FloatRect(0, 0, 640, 480));

	Level lvl;//������� ��������� ������ �������
	lvl.LoadFromFile("/home/evgenia/CLionProjects/Our_Project/map1.tmx");//��������� � ���� �����, ������ ������ � ������� ������� �� �� ����������.
	...
	Image heroImage;
	heroImage.loadFromFile("/home/evgenia/CLionProjects/Our_Project/images/MilesTailsPrower.gif");

	Image easyEnemyImage;
	easyEnemyImage.loadFromFile("/home/evgenia/CLionProjects/Our_Project/images/shamaich.png");
